...
#print "$recv_msg\n" if $VERBOSE;
 ...
 if (inet_ntoa($viewmaster_inet) eq $IN_IP){
print "Matches required ip\n";
...
#open(QUERY, ">/Users/labgooglemini/Documents/GE/query.txt");
#print QUERY 
my $queryformat = "flytoview=<LookAt>".
"<latitude>$viewsync[1]</latitude>".
"<longitude>$viewsync[2]</longitude>".
"<altitude>$viewsync[3]</altitude>".
"<heading>$viewsync[4]</heading>".
"<tilt>$viewsync[5]</tilt>".
"<roll>$viewsync[6]</roll>".
"<altitudeMode>relativeToGround</altitudeMode>".
"</LookAt>";
system("echo \"$queryformat\" > ~/Documents/GE/query.txt");
#close(QUERY);
